...
<script src="https://cdn.jsdelivr.net/npm/p5.party@latest/dist/vanilla-party.js"></script>
```
...
The quickest way to get started with p5.party is to load it from a [CDN](https://cdn.jsdelivr.net/npm/p5.party@latest/dist/vanilla-party.js) or download the latest [release](https://github.com/jbakse/p5.party/releases) .
